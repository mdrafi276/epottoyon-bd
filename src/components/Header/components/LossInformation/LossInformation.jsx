...
const LossInformation = () => {
    ...
    return (
        <div className=" lg:my-5 align-top container mx-auto lg:py-14  flex flex-col gap-5 lg:flex-row  ">
            <div className="w-full border border-gray-300 py-5  flex-col lg:flex-row shadow-xl">
