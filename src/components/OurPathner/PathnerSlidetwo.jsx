      ...
      <div className="w-full lg:w-[98%] mx-auto flex-col lg:flex-row shadow-xl">
        <div className="lg:min-h-[450px]  grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-6 gap-4 p-5">
          {services?.map((service) => (
            <div
              className="text-center flex flex-col justify-center bg-[#c6c6c6] items-center cursor-pointer shadow-md hover:shadow-lg hover:bg-gray-100  rounded p-2 h-fit gap-2"
              key={service?.id}
            >
