        ...
        <div className="w-full lg:w-2/3 flex-col border-2 border-black lg:flex-row shadow-xl">
            ...
            <div className="h-96 overflow-y-scroll grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 p-5">
                {services
                    ...
                    ?.map((service) => (
                        <div
                            className="text-center cursor-pointer shadow-md bg-[#2b5b2e] text-white hover:text-black hover:shadow-lg hover:bg-gray-100 transition-all rounded p-2 h-44 sm:h-fit flex flex-col gap-2 items-center justify-center"
                            key={service?.id}
                        >
                            <img
