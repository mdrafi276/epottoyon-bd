      ...
      <div className="w-[99%] mx-auto flex items-center justify-end">
        ...
        >
          <div
            ...
            className={`absolute w-full lg:h-[500px] overflow-y-scroll  lg:w-[600px] bg-white drop-shadow-2xl rounded-lg ${
              openModal
            ...
            <form className="p-12">
              ...
              <div className="space-y-1 mt-2">
                ...
                <div className="relative text-ellipsis">
                  <input
                    ...
                    type="email"
                    placeholder="ইমেল"
                    className="p-3 mb-3 block w-full text-black pl-10 drop-shadow-lg rounded-lg outline-none"
                  />
                ...
                <div className="relative mt-2 ">
                  <input
                    ...
                    className="p-3 block w-full pl-10 drop-shadow-lg rounded-lg outline-none text-black"
                  />
                  <span className="absolute  text-black top-1/4 left-2">
                    <RiLockPasswordFill />
                  </span>
              ...
              <div className="mt-5">
                <h1 className="text-[14px] animate-pulse text-[#ab2828]">
                  বি:দ্রঃ সনদ প্রাপ্তির জন্য নিবন্ধিত নাগরিক হিসেবে আপনার ঠিকানা
                  সহ সাধারণ তথ্য দিয়ে প্রোফাইল ১০০% সম্পন্ন করার প্রয়োজনীয়তা
                  রয়েছে।
                </h1>
              </div>
            </form>
