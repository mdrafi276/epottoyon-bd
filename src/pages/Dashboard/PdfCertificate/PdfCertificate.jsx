...
const PdfCertificate = (props) => {
  const { certificate, unionName, upazillaName, districtName, sanadType } =
    props;
  ...
  return (
    <div className="bg-white md:pt-16  lg:pt-1">
      <div className=" md:w-[680px]  w-[97%] lg:w-[900px] bg-[#F2EEEB]  mx-auto border-4  border-[#7030A0] lg:mt-2">
        <div className="flex justify-between md:w-[90%] lg:w-[90%] mx-auto mt-8  md:mt-5 lg:mt-4 items center ">
          <figure>
            <img
        ...
        <div className="lg:w-[90%] md:w-[90%] lg:mt-5 w-[85%] mx-auto">
        ...
        <div className="bg-opa lg:pb-16 md:pb-2 lg:pt-5 lg:mt-1 md:mt-1   bg-center  bg-no-repeat">
          ...
          <div className="flex lg:w-[90%] md:w-[90%] w-[85%] mx-auto  items-start justify-between   ">
            ...
            <div>
              <h1 className="text-[12px] lg:mt-8 md:mt-6 md:text-[19px] lg:text-[26px] bg-[#B4D5FF] rounded-t-full rounded-b-full rounded-s-full rounded-r-full md:py-3  md:px-[30px] lg:px-[68px] text-black lg:pb-8 font-normal text-center">
            ...
            <div className="w-[90%] mx-auto md:mt-4 lg:mt-8  ">
              <h1 className="text-[12px] text-justify lg:mt-3 md:leading-7 lg:leading-8 md:text-[14px] lg:text-[17px] ">
                {certificate?.language === "en"
                  ? `In this regard, an ${
                      sanadType?.description
                    } is being provided for ${certificate?.applicant}, ${
                      certificate?.nid
                        ? "National Id Card No:"
              ...
              <h1 className="text-[12px] md:mt-2 lg:mt-3 lg:leading-9 md:text-[14px] lg:text-[17px]">
                {certificate?.language === "en"
              ...
              <table className="w-full border-collapse">
                <thead className="bg-blue-500 text-white">
                  <tr>
                    ...
                    <th className="  text-[10px]  md:text-[14px] lg:px-4 py-2">
                      {certificate?.language === "en" ? "Relation" : "সম্পর্ক"}
                    </th>
                    <th className="  text-[10px]  md:text-[14px] lg:px-4 py-2">
                      {certificate?.language === "en"
                    ...
                    <th className="text-[10px] md:text-[14px]  px-3 md:px-4 py-2">
                      {certificate?.language === "en" ? "Comment" : "মন্তব্য"}
                    </th>
                  </tr>
                </thead>
        ...
        <div className="  flex justify-between mx-auto w-full lg:w-[80%] md:w-[80%] items-end lg:mt-5 lg:mb-10 md:mb-4 md:mt-2">
          <QRCode
            size={100}
            bgColor="white"
            fgColor="black"
