            ...
            <div>
              <div className="w-[90%] mx-auto md:mt-2 lg:mt-8  ">
                ...
                <h1 className="text-[12px] text-justify lg:mt-3 md:leading-7 lg:leading-8 md:text-[14px] lg:text-[17px]  ">
                  ...
                  গ্রাম: {certificate?.village_name || certificate?.mrgram},
                  ওয়ার্ডঃ {certificate?.ward_no || certificate?.mrword}, ডাকঘর:{" "}
                  {certificate?.mrdak}, ইউনিয়ন:{" "}
                  {certificate?.language === "en" || !!certificate?.language
                    ? unionName?.name
                    : unionName?.bn_name}
                  , উপজেলা: {upazillaName?.bn_name}, জেলা:{" "}
                  {districtName?.bn_name} তিনি আমার ইউনিয়নের{" "}
                  {certificate?.ward_no || certificate?.mrword} নং ওয়ার্ডের একজন
                  স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও জানি। সে সমাজ
