...
const PdfCertificate = () => {
    ...
    return (
      <div className="bg-white lg:pt-5">
        {" "}
        <div className=" md:w-[700px] w-[97%] lg:w-[900px] bg-[#F2EEEB]  mx-auto border-4  border-[#7030A0] lg:mt-5">
          <div className="flex justify-around mt-8 md:mt-10 lg:mt-14 items center ">
            ...
            <div>
              ...
              <h1 className="text-[14px] text-center font-semibold lg:text-[34px] md:text-[26px] text-[#7030A0]">
                ৩ নং গয়হাটা ইউনিয়ন পরিষদ
              </h1>
              <h1 className="text-[14px] text-center text-black md:text-[21px] lg:text-[20px]">
          ...
          <div className=" bg-opa lg:pb-16 lg:pt-5 lg:mt-10   bg-contain bg-center  bg-no-repeat">
            {" "}
            ...
            <div>
              <div className="w-[90%] mx-auto  lg:mt-8  ">
                {" "}
                <h1 className="text-[12px] text-justify lg:mt-3 lg:leading-8 lg:text-[17px]  ">
                  ...
                  <span> সামচুল হক মালংগি</span>, মাতাঃ <span>আমেনা বেগম</span>,
                  গ্রামঃ
                  ...
                  <span> শরীয়তপুর</span> তিনি আমার ইউনিয়নের <span>০৯ </span>নং
                  ওয়ার্ডের একজন স্থায়ী বাসিন্দা। আমি তাকে ব্যক্তি গত ভাবে চিনি ও
                  জানি। সে সমাজ বা রাষ্ট্র বিরোধী কোন প্রকার কাজের সহিত জড়িত
                  নাই। সে অত্র ইউনিয়নের একজন স্থায়ী বাসিন্দা ও নাগরিক। আমার জানা
                  মতে সে একজন ভূমিহীন।
                </h1>
          ...
          <div className="flex justify-around items-center  ">
            <div className="lg:w-[120px] border-gray-400 flex rounded-full justify-center items-center lg:h-[120px] border-2">
              {" "}
          ...
          <div className=" flex justify-around items-center lg:mt-5 lg:mb-14">
            ...
            <div>
              <h1 className="text-[12px] lg:text-[16px] text-center">
                সনদটি যাচাই করতে আপনার মোবাইলে থাকা QR CODE অ্যাপ দিয়ে স্ক্যান
                করুন
              </h1>
            </div>
          </div>
