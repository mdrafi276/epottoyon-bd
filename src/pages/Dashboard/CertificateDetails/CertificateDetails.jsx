      ...
      <div className=" bg-[#F4F6F9] min-h-screen ">
        <div className="w-[99%] mx-auto  lg:py-8  ">
          ...
          <div className="w-full flex justify-center items-center mt-5">
              ...
              <button onClick={handlePrint} className="lg:py-2 items-center gap-2 flex lg:px-5 md:px-5 py-1 px-4  md:py-2 text-[14px] md:text-[15px] lg:text-[16px] rounded-md bg-[#0069D9] text-white">
